...
master_scrip_list = other_file_path + 'Script_List.xlsx'
nse_holiday_list = other_file_path + 'NSE_Holiday_List.xlsx'
daily_report_name = 'Daily_Report'
sheet_name_price_volume = 'Price-Volume'
